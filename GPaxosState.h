...
public:
	...
	U64 m_iMaxCommitTxid; // commit id increase when log commit an item, could be used for electing new leader,最新commit的txid

	U64 m_iPrevTxid;	//useless
	U32 m_iCurrentEpoch;	//current epoch,leader选举的过程中，m_iCurrentEpoch可能大于m_iLeaderEpoch，因为可能Leader过时了
	U64 m_iCurrentTxid;	//????
	U32 m_iTxCounter;//????
